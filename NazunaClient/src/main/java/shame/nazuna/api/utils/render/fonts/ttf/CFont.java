...
public class CFont {
    ...
    public boolean isFractionalMetrics() { return this.fractionalMetrics; }
    public int getGlTextureId() { return this.glTextureId; }
    ...
    public void drawChar(CharData[] chars, char c, float x, float y, Matrix4f matrix, BufferBuilder buffer) {
        try {
            ...
            drawQuad(x, y, (chars[c]).width, (chars[c]).height, (chars[c]).storedX, (chars[c]).storedY, (chars[c]).width, (chars[c]).height, matrix, buffer);
