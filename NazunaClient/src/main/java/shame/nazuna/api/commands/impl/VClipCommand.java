 ...
 public class VClipCommand extends Command {
   ...
   private void clipToSafeBlock(boolean up) {
     ...
     for (y = from; up ? (y <= to) : (y >= to); ) {
       ...
       class_265 shape = mc.field_1687.method_8320(new class_2338(mc.field_1724.method_31477(), y - 1, mc.field_1724.method_31479())).method_26220((class_1922)mc.field_1687, new class_2338(mc.field_1724.method_31477(), y - 1, mc.field_1724.method_31479()));
       double offsetY = shape.method_1110() ? 0.0D : shape.method_1105(class_2350.class_2351.field_11052);
   ...
   private boolean isSafeStandPosition(int y) {
     ...
     if (floorState.method_26220((class_1922)mc.field_1687, floorPos).method_1110()) {
       return false;
     }
     
     return (mc.field_1687.method_8320(feetPos).method_26220((class_1922)mc.field_1687, feetPos).method_1110() && mc.field_1687
       .method_8320(headPos).method_26220((class_1922)mc.field_1687, headPos).method_1110());
   }
 }
