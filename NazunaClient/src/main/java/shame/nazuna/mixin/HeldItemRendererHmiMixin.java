 ...
 public abstract class HeldItemRendererHmiMixin {
   ...
   private void renderCustomFirstPersonItem(class_742 player, float tickDelta, float pitch, class_1268 hand, class_1306 arm, float sideFactor, float swingProgress, class_1799 item, float equipProgress, class_4587 matrices, class_4597 vertexConsumers, int light) {
     ...
     if (swings.isEnable() && swings.hmiEnable.isState() && 
       ...
       float swing_rot = (hmiProgress < 0.6D) ? class_3532.method_15374(class_3532.method_15363(hmiProgress, 0.0F, 0.12506F) * 12.56F) : class_3532.method_15374(class_3532.method_15363(hmiProgress, 0.62532F, 0.75038F) * 12.56F);
       float swing = class_3532.method_15374(hmiProgress * 3.14F);
       swing = easeInOutBack(swing);
       boolean sharpSword = (item.method_31573(class_3489.field_42611) && isSharpAnimation(config));
       ...
       if (!item.method_7960()) {
         ...
         if ((this.left || item.method_31573(class_3489.field_42612) || item.method_7976() == class_1839.field_8951 || item.method_7976() == class_1839.field_8949) && !item.method_31573(class_3489.field_42615)) {
           if (sharpSword) {
             ...
             if (item.method_7976() == class_1839.field_8951) {
             ...
             } else if (item.method_31573(ConventionalItemTags.TOOLS) && item.method_7976() != class_1839.field_8949 && !item.method_31573(class_3489.field_42615)) {
               matrices.method_22904(0.1D * sideFactor * swing_rot, 0.1D * swing_rot, -0.5D * swing);
               matrices.method_22907(class_7833.field_40713.rotationDegrees(-30.0F * swing_rot));
               matrices.method_22907(class_7833.field_40718.rotationDegrees(-20.0F * swing_rot * sideFactor));
               matrices.method_22907(class_7833.field_40713.rotationDegrees(40.0F * swing));
       ...
       if (player.method_6101() && config.climbAndCrawl && !player.method_24828() && !item.method_31574(class_1802.field_16539) && !item.method_31574(class_1802.field_22016) && !player.method_6115()) {
       ...
       if (player.method_18798().method_10214() < -0.85D && item.method_31574(class_1802.field_49814) && player.method_6047() == item) {
       ...
       if (player.method_5681() && swingProgress == 0.0F && config.swimmingAnimation) {
         ...
         matrices.method_22907(class_7833.field_40715.rotationDegrees((float)(bl ? (b * 30.0D) : (b * 30.0D * -1.0D))));
       ...
       if (((player.method_6101() && !player.method_24828()) || (player.method_20448() && swingProgress == 0.0F)) && !player.method_6115()) {
         ...
         float a = class_3532.method_15362((float)s * 2.0F);
         if (player.method_6101()) {
           if (!item.method_31574(class_1802.field_16539) && !item.method_31574(class_1802.field_22016)) {
             matrices.method_22907(class_7833.field_40714.rotationDegrees(20.0F * a * sideFactor));
           } else {
             matrices.method_22907(class_7833.field_40714.rotationDegrees(1.0F * a * sideFactor));
           } 
         }
       ...
       if (item.method_7960()) {
         ...
         if (player.method_6115() && player.method_6014() > 0 && player.method_6058() == hand) {
           ...
           float f = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
           float g = f / class_1764.method_7775(item, (class_1309)player);
           if (g > 1.0F) {
             g = 1.0F;
           }
         ...
         acc.invokeRenderItem((class_1309)player, item, bl3 ? class_811.field_4322 : class_811.field_4321, !bl3, matrices, vertexConsumers, light);
         matrices.method_22909();
         if (player.method_6115() && player.method_6014() > 0 && player.method_6058() == hand) {
           float f = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
           float g = f / class_1764.method_7775(item, (class_1309)player);
           ...
           matrices.method_22907(class_7833.field_40715.rotationDegrees((g <= 0.2D) ? (75.0F * g * 5.0F * i) : (75 * i)));
           matrices.method_22907(class_7833.field_40713.rotationDegrees(10.0F * g * 1.5F));
         ...
         if (player.method_6115() && player.method_6014() > 0 && player.method_6058() == hand) {
           HeldItemRendererAccessor acc; float u; float y; float q; float c; HeldItemRendererAccessor acc4; float k; float s; float s2; HeldItemRendererAccessor acc5; float m1; float f1; float f; HeldItemRendererAccessor acc1; float m; HeldItemRendererAccessor acc0; float f5; float g5; float h5; float n; float z; float x; HeldItemRendererAccessor acc78; HeldItemRendererAccessor acc67; switch (item.method_7976()) {
             ...
             case field_8950:
             case field_8946:
               u = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
               y = u / 5.0F;
               if (y > 1.0F) {
                 y = 1.0F;
               }
               
               q = class_3532.method_15374(u / 2.0F * 3.14F);
               q /= 10.0F;
               matrices.method_22904((1 * l), 0.1D, 0.3D);
               matrices.method_22904(0.2D * l * y, -0.7D * y, -0.2D * y);
               matrices.method_22904(0.0D, -0.2D * q, -0.2D * q);
               matrices.method_22904(0.0D, 0.1D * easeInOutBack(class_3532.method_15374(y * 3.14F)), 0.0D);
               ...
               matrices.method_22907(class_7833.field_40714.rotationDegrees(30.0F));
               altSwing(matrices, arm, swingProgress, item);
               c = class_3532.method_15374(equipProgress * 3.14F);
               matrices.method_22905(0.9F, 0.9F, 0.9F);
               ...
               break;
             case field_8949:
               k = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
               s = k / 4.0F;
               s2 = k / 6.0F;
               if (s > 1.0F) {
                 s = 1.0F;
               ...
               matrices.method_22907(class_7833.field_40714.rotationDegrees((float)(10.0D * Math.sin(s2 * 3.14D))));
               matrices.method_22907(class_7833.field_40716.rotationDegrees(70.0F * s * l));
               matrices.method_22907(class_7833.field_40716.rotationDegrees((45 * l)));
               matrices.method_22907(class_7833.field_40718.rotationDegrees((-40 * l)));
               matrices.method_22907(class_7833.field_40714.rotationDegrees(30.0F));
               matrices.method_22907(class_7833.field_40716.rotationDegrees((5 * l) * s));
               matrices.method_22907(class_7833.field_40714.rotationDegrees(-10.0F * s));
             ...
             case field_8953:
               ...
               m1 = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
               f1 = m1 / 20.0F;
             ...
             case field_8951:
               ...
               m = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
               f = m / 10.0F;
               if (f > 1.0F) {
                 f = 1.0F;
               }
               ...
               if (f > 0.1F) {
                 float g = class_3532.method_15374((m - 0.1F) * 1.3F);
                 float h = f - 0.1F;
                 float j = g * h;
             ...
             case field_42717:
               ...
               h5 = 1.0F - g5 / 10.0F;
               n = -15.0F + 75.0F * class_3532.method_15362(h5 * 2.0F * 3.1415927F);
               z = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
               x = z / 4.0F;
               if (x > 1.0F) {
                 x = 1.0F;
               }
           ...
           float m = item.method_7935((class_1309)player) - player.method_6014() - tickDelta + 1.0F;
           float f = m / 10.0F;
           if (f > 1.0F) {
             f = 1.0F;
           }
           ...
           matrices.method_22904(0.0D, 0.0D, 0.01D * class_3532.method_15374(this.riptideCounter * 6.28F));
           HeldItemRendererAccessor acc = (HeldItemRendererAccessor)this;
         ...
         if (class_2248.method_9503(item.method_7909()) != class_2246.field_10124 && item.method_7976() != class_1839.field_8950 && !item.method_31573(ConventionalItemTags.BUCKETS)) {
         ...
         if (item.method_7909() instanceof class_1747 && ((!item.method_31573(ConventionalItemTags.BUCKETS) && item.method_7976() != class_1839.field_8950 && !item.method_31573(class_3489.field_15556) && !item.method_31574(class_1802.field_8276) && !item.method_31574(class_1802.field_8725) && !item.method_31574(class_1802.field_8865) && !item.method_31574(class_1802.field_8366) && !class_2248.method_9503(item.method_7909()).method_9564().method_26164(ConventionalBlockTags.GLASS_PANES) && !class_2248.method_9503(item.method_7909()).method_9564().method_26164(class_3481.field_15463) && !class_2248.method_9503(item.method_7909()).method_9564().method_26164(class_3481.field_22414) && !item.method_31573(class_3489.field_15553)) || class_2248.method_9503(item.method_7909()).method_9564().method_26164(class_3481.field_15503)) && !class_2248.method_9503(item.method_7909()).method_9564().method_26164(class_3481.field_43170)) {
           ...
           if (blockItem.method_7711() == class_2246.field_10450 && this.repPower) {
             blockState = (class_2680)blockState.method_11657((class_2769)class_2462.field_10911, Boolean.valueOf(true));
           }
           
           if (blockItem.method_7711() == class_2246.field_10377 && this.repPower) {
             blockState = (class_2680)blockState.method_11657((class_2769)class_2286.field_10911, Boolean.valueOf(true));
           }
           
           if (blockItem.method_7711() == class_2246.field_10523 && player.method_5869()) {
             blockState = (class_2680)blockState.method_11657((class_2769)class_2459.field_11446, Boolean.valueOf(false));
           }
           
           if ((blockItem.method_7711() == class_2246.field_17350 || blockItem.method_7711() == class_2246.field_23860) && player.method_5869()) {
             blockState = (class_2680)blockState.method_11657((class_2769)class_3922.field_17352, Boolean.valueOf(false));
           }
           ...
           if (!item.method_31574(class_1802.field_8137) && (!item.method_31574(class_1802.field_8301) || !config.mb3DCompat)) {
             ...
             matrices.method_22904(0.0D, 0.25D + 0.02D * class_3532.method_15374(this.netherCounter * 0.1F), 0.0D);
             matrices.method_22907(class_7833.field_40714.rotationDegrees(3.0F * class_3532.method_15374(this.netherCounter * 0.2F)));
             matrices.method_22905(1.0F + 0.01F * class_3532.method_15374(this.netherCounter), 1.0F + 0.01F * class_3532.method_15374(this.netherCounter), 1.0F + 0.01F * class_3532.method_15374(this.netherCounter));
           } 
           ...
           if (item.method_31574(class_1802.field_8810)) {
             player.method_37908().method_8406((class_2394)class_2398.field_11246, player.method_19538().method_10216(), player.method_19538().method_10214(), player.method_19538().method_10215(), 0.1D, 0.1D, 0.1D);
           }
           
           HeldItemRendererAccessor acc = (HeldItemRendererAccessor)this;
           acc.invokeRenderItem((class_1309)player, item, bl2 ? class_811.field_4322 : class_811.field_4321, !bl2, matrices, vertexConsumers, light);
         } 
       } 
