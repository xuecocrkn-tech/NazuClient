package shame.nazuna.client.modules.impl.render;
   ...
   extends Record
 {
   ...
   public final String toString() {
     ...
     //   0	7	0	this	Lshame/astra/client/modules/impl/render/Trajectories$ProjectileParams;
   }
   ...
   private ProjectileParams(double velocity, double gravity, double drag) {
     this.velocity = velocity; this.gravity = gravity; this.drag = drag; } public double velocity() { return this.velocity; } public double gravity() { return this.gravity; } public double drag() { return this.drag; }
 
 }


/* Location:              C:\User\\user\Downloads\astra-1.0.0.jar!\shame\astra\client\modules\impl\render\Trajectories$ProjectileParams.class
