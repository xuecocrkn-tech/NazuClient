package shame.nazuna.client.modules.impl.render.base.implement;
 ...
 public class ArrayListHud extends InterfaceProcessing {
   ...
   private static final class ModuleEntry extends Record { private final String lowerName; private final float width; private final float anim;
     private ModuleEntry(String lowerName, float width, float anim) { this.lowerName = lowerName; this.width = width; this.anim = anim; } public final String toString() { // Byte code:
       //   0: aload_0
       ...
       //   0	7	0	this	Lshame/astra/client/modules/impl/render/base/implement/ArrayListHud$ModuleEntry; } public String lowerName() { return this.lowerName; } public final int hashCode() { // Byte code:
       //   0: aload_0
       ...
       //   0	8	1	o	Ljava/lang/Object; } public float width() { return this.width; } public float anim() { return this.anim; }
      }
